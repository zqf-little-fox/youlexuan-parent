...
<body  ng-app="youlexuan" ng-controller="itemPageController" ng-init="num=1;loadSku()" >
<#include "head.ftl">
<#--图片-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
					        ...
					        <#list spec.attributeValue as item >
								<dd>
                                    <a  class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}"
							...
							<ul class="goods-list unstyled">
								<li>
									<div class="list-wrap">
										...
										<div class="operate">
											<a href="#" class="sui-btn btn-bordered">加入购物车</a>
										</div>
									</div>
								</li>
								<li>
