...
import com.youlexuan.mapper.TbAddressMapper;
import com.youlexuan.pojo.TbAddress;
import com.youlexuan.pojo.TbAddressExample;
import com.youlexuan.pojo.TbAddressExample.Criteria;
...
public class AddressServiceImpl implements AddressService {
	...
	public List<TbAddress> findListByUserId(String userId) {
		...
		TbAddressExample exam = new TbAddressExample();
		exam.createCriteria().andUserIdEqualTo(userId);
		return addressMapper.selectByExample(exam);
